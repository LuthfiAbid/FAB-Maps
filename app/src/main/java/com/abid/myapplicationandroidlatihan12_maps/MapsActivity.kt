package com.abid.myapplicationandroidlatihan12_maps
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        speedDial.addActionItem(
            SpeedDialActionItem.Builder(R.id.satellite, R.drawable.ic_sattelite_24dp)
                .setLabel("Satellite")
                .create()
        )
        speedDial.addActionItem(
            SpeedDialActionItem.Builder(R.id.hybrid, R.drawable.ic_hybrid_24dp)
                .setLabel("Hybrid")
                .create()
        )
        speedDial.addActionItem(
    ...
    private fun settingUpMaps() {
        ...
        fusedLocationProviderClient.lastLocation.addOnSuccessListener(this) { location ->
            if (location != null) {
                ...
                placeMarkerInMaps(currentPosition)
                mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(currentPosition, 20.0f))
            }
        }
    }
